  ...
  var handleException = (e) => {
      ...
      if (e instanceof WebAssembly.RuntimeError) {
        if (_emscripten_stack_get_current() <= 0) {
          err('Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 8192000)');
        }
      }
      quit_(1, e);
    };
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['keydown'] != 'undefined', 'missing Wasm export: keydown');
  assert(typeof wasmExports['remote'] != 'undefined', 'missing Wasm export: remote');
  ...
  _keydown = Module['_keydown'] = createExportWrapper('keydown', 6);
  _remote = Module['_remote'] = createExportWrapper('remote', 4);
